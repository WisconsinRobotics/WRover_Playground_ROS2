...
#include "custom_msgs_srvs/msg/detail/ir_sensor_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_msgs_srvs::msg::IRSensorData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_msgs_srvs::msg::IRSensorData & ros_message)
{
  // Member: distances
  {
    cdr >> ros_message.distances;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_custom_msgs_srvs
max_serialized_size_IRSensorData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_msgs_srvs::msg::IRSensorData;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_custom_msgs_srvs
max_serialized_size_key_IRSensorData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const custom_msgs_srvs::msg::IRSensorData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_msgs_srvs::msg::IRSensorData *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _IRSensorData__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const custom_msgs_srvs::msg::IRSensorData *>(
...
static size_t _IRSensorData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_IRSensorData(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _IRSensorData__callbacks = {
...
static rosidl_message_type_support_t _IRSensorData__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_IRSensorData__callbacks,
...
{
  return &custom_msgs_srvs::msg::typesupport_fastrtps_cpp::_IRSensorData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msgs_srvs, msg, IRSensorData)() {
  return &custom_msgs_srvs::msg::typesupport_fastrtps_cpp::_IRSensorData__handle;
}
